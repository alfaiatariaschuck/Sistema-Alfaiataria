...
function rowParaPedido(row) {
  return {
    ...
    origemPlanoId: row.origem_plano_id || null,
...
const CAMPO_PARA_COLUNA = {
  ...
  valorPorCamisaFabiana: "valor_por_camisa_fabiana",
    ...
    return comIndicador(async () => {
      ...
      const { data: pedidoRow, error } = await supabase
        ...
        .insert({
          ...
          costureira: p.costureira || "Fabiana",
          ...
          valor_por_camisa_fabiana: p.valorPorCamisaFabiana === "" || p.valorPorCamisaFabiana == null ? null : Number(p.valorPorCamisaFabiana),
